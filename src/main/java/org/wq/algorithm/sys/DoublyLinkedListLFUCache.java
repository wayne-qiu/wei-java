...
public class DoublyLinkedListLFUCache {
    ...
    public DoublyLinkedListLFUCache(int capacity) {
    ...
    public static void main(String[] args) {
        DoublyLinkedListLFUCache cache = new DoublyLinkedListLFUCache(2);
